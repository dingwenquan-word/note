...
## Pi Network项目介绍
**重要重要重要：
Pi已经上线主网，可在交易所交易，实时价格：**
https://coinmarketcap.com/zh/currencies/pi/
...
**此教程分下载、注册、创建钱包和身份认证几个步骤，是为阅读英文有障碍的小白而写的注册教程，如果你能完全阅读英文，那么可以跳过该教程，只需要注册时填写我的邀请码QwenDing。**
...
官网同步app：https://stephen3.lanzouw.com/i0qpX2ocfhij
或者扫码下载 （这个是同步官网app维护的安装包，安全可靠。）

![image](https://github.com/user-attachments/assets/31283edf-ccb3-4f19-a972-ff6bd9f97bae)
...
4.填入名、姓、用户名，建议注册时的姓名要用真实姓名，因为上主网需要严格的kyc（一种金融认证手段，防止一人多号)。

![](https://i.imgur.com/dBN71YM.png)

5.填入邀请码invitation node，我的邀请码：QwenDing，用户与用户之间不存在上下级关系，请放心填写。
...
后期系统会把没有通过验证的用户清理掉，因为官方会认为你是机器人，是刷号的，当然你辛辛苦苦挖的矿也就没有了，所以短信验证是很重要的一步。
步骤如下：
01. 点开菜单选择Profile
02. 选Verify
03. 选Start
...
弹出的页面中，可以选择地区，这里可以选择美国（US）或者英国（UK）等其他服务区，**移动、联通手机号选择英国，电信号选择美国**，然后选择START，如果不通过每个区都试一下
...
## KYC-身份认证，非常重要
**为了让pi网络中的人都是真实的，需进行身份认证，过滤掉刷子和机器人，一人一号，公平公正，防止代币过度集中（这很重要）
可在pi network中点击mainnet主网，主网清单总共8大步骤需要你做，很简单按步骤做就行，要特别注意，英文名字就是汉语拼音（一定要和身份证一样，后期过kyc会审核），创建钱包的助记词一定要保存好，丢失不可找回
...
如上图所示，每日挖矿的速度由三部分构成，注意这是早期的速率，现在已经随着网络的壮大进行了多次减产，现在挖矿速率很低了。
...
1、记得每24小时内上去点一下【绿色闪电】去收矿！注册成功72小时以后开启安全圈了可以翻倍。**基于挖矿动作实现公平分发代币，不要小看这一步，这是防止代币过度集中很好的方式，你也可以理解这是注意力代币**

2、未来团队会开发钱包功能（现在已经开发了哦），到时候你就可以把币转进你的钱包，由你自己保管。目前挖矿无需任何金钱成本，所以小伙伴们赶快行动起来，抓住项目早期的红利吧！自己的邀请码在菜单里的‘Profile’

3、**注册后一定要进行手机号认证、邮箱认证、身份认证！然后才能迁移到主网**
