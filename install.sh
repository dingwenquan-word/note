...
# mysql配置
# mysql 地址,端口
mysqlHost="192.168.1.22:3306"

# mysql 数据库名称
mysqlDb="escheduler"

# mysql 用户名
mysqlUserName="schedule_work"

# mysql 密码
# 注意：如果有特殊字符，请用 \ 转移符进行转移
mysqlPassword="sfdDtrt"
...
# zk集群
zkQuorum="twin-cloud01:2181,twin-cloud02:2181,twin-cloud03:2181"
...
masters="twin-cloud01"

# 运行Worker的机器
# 注意：部署worker的机器hostname列表
workers="twin-cloud02,twin-cloud03"

# 运行Alert的机器
# 注意：部署alert server的机器hostname列表
alertServer="twin-cloud03"

# 运行Api的机器
# 注意：部署api server的机器hostname列表
apiServers="twin-cloud02"
...
defaultFS="hdfs://twin-cloud01:8020"
